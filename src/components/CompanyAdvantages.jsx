...
const CompanyAdvantages = () => {
    return (
        <div className="container text-center">
            ...
            <div className="row">
                <div className="col-md-3 d-flex align-items-center mb-4">
                    <img src={kot} alt="Качество и доступность услуг" style={{ maxWidth: '150px', marginLeft: "auto" }} />
                </div>
            ...
            <div className="row">
                <div className="col-md-3 d-flex align-items-center mb-4">
                    <img src={kot} alt="Есть онлайн консультация" style={{ maxWidth: '150px', marginLeft: "auto" }} />
                </div>
                <div className="col-md-9">
